...
namespace FantasyMod2.Content.Items.Hooks
{
    internal class PoseidonsGrasp : ModItem
    {
        public override void SetDefaults()
        {
            // Copy values from the Amethyst Hook
            Item.CloneDefaults(ItemID.DiamondHook);
            Item.shootSpeed = 31f; // This defines how quickly the hook is shot.
            Item.shoot = ModContent.ProjectileType<PoseidonsGraspProjectile>(); // Makes the item shoot the hook's projectile when used.
    ...
    internal class PoseidonsGraspProjectile : ModProjectile
    {
        ...
        { // This is called once on mod (re)load when this piece of content is being loaded.
          // This is the path to the texture that we'll use for the hook's chain. Make sure to update it.
            chainTexture = ModContent.Request<Texture2D>("FantasyMod2/Content/Items/Hooks/PoseidonsGraspChain");
        }
