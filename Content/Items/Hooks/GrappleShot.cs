...
{
    internal class GrappleShot : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<GrappleShotProjectile>(); // Makes the item shoot the hook's projectile when used.
    ...
    internal class GrappleShotProjectile : ModProjectile
    {
        ...
        { // This is called once on mod (re)load when this piece of content is being loaded.
          // This is the path to the texture that we'll use for the hook's chain. Make sure to update it.
            chainTexture = ModContent.Request<Texture2D>("FantasyMod2/Content/Items/Hooks/GrappleShotChain");
        }
