...
namespace FantasyMod2.Content.Items.Weapons
{
    ...
    /// </summary>
    public class RedrixsInquiry : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<Inquire>(); // Remember that we must use ProjectileType<>() since it is a modded projectile!
