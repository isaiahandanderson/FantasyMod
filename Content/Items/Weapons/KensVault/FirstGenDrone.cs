...
namespace FantasyMod2.Content.Items.Weapons.KensVault
{
    ...
    public class DroneBuff : ModBuff
    {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            if (player.ownedProjectileCounts[ModContent.ProjectileType<FirstGenDrone>()] > 0)
            {
    ...
    public class FirstGenRemote : ModItem
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void SetDefaults()
        {
            ...
            Item.buffType = ModContent.BuffType<DroneBuff>();
            // No buffTime because otherwise the item tooltip would say something like "1 minute duration"
            Item.shoot = ModContent.ProjectileType<FirstGenDrone>(); // This item creates the minion projectile
        }
    ...
    public class FirstGenDrone : ModProjectile
    {
        public override void SetStaticDefaults()
        {
