using FantasyMod2.Content.Items.Weapons.Tomes;
using Terraria;
...
{
    public class ImmaculateConception : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.DefaultToStaff(ProjectileID.RainbowRodBullet, 7, 20, 11);
            Item.width = 34;
            Item.height = 40;
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient<RosesValidation>(1);
            recipe.AddIngredient<BeautifulCatalyst>(1);
