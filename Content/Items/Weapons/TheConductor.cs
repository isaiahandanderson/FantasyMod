...
namespace FantasyMod2.Content.Items.Weapons
{
    ...
    /// </summary>
    public class TheConductor : ModItem
    {
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<Conduct>(); // Remember that we must use ProjectileType<>() since it is a modded projectile!
