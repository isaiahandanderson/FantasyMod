...
{
    public class BeardedSpear : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<Bearded>(); // The projectile that is fired from this weapon
        }
        ...
        public override void AddRecipes()
        {
            ...
            recipe.AddIngredient<ReferenceManual>(1);
