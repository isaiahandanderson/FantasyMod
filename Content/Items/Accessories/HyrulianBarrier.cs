...
{
    public class HyrulianBarrier : ModItem
    {
    ...
    public class HyrulianBarrierPlayer : ModPlayer
    {
        public bool HyrulianBarrier = false;

        public override void ResetEffects()
        {
            HyrulianBarrier = false;
        }

        public override void PostUpdateRunSpeeds()
        {
            // We only want our additional changes to apply if ExampleStatBonusAccessory is equipped and not on a mount.
            if (Player.mount.Active || !HyrulianBarrier)
            {
                return;
            }
