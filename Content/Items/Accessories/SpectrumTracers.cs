...
namespace FantasyMod2.Content.Items.Accessories
{
    ...
    public class SpectrumTracers : ModItem
    {
        ...
        public override void UpdateAccessory(Player player, bool hideVisual)
        {
            ...
            player.moveSpeed += MoveSpeedBonus / 150f; // Modifies the player movement speed bonus.
            player.accRunSpeed = 8.25f; // Sets the players sprint speed in boots.
            ...
            if (!hideVisual)
            {
                // This ensures that boot visual effects don't overlap if multiple are equipped
