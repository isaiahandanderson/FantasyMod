...
namespace FantasyMod2.Content.Projectiles
{
    ...
    public class ScarletPlagueProjectile : ModProjectile
    {
        ...
        private const float SPINRANGE = 4f * (float)Math.PI; // The angle a spin attack covers (630 degrees)
        private const float WINDUP = 0.4f; // How far back the player's hand goes when winding their attack (in relation to swingRange)
        ...
        public override string Texture => "FantasyMod2/Content/Items/Weapons/ScarletPlague"; // Use texture of item as projectile texture
