...
using FantasyMod2.Content.Dusts;
...
namespace FantasyMod2.Content.Projectiles
{
    ...
    public class JerickoProj : ModProjectile
    {
        private const string ChainTexturePath = "FantasyMod2/Content/Projectiles/JerickoChain"; // The folder path to the flail chain sprite
        private const string ChainTextureExtraPath = "FantasyMod2/Content/Projectiles/JerickoChainExtra";  // This texture and related code is optional and used for a unique effect
        ...
        public override void AI()
        {
			...
			*/
            ...
            if (Main.rand.NextBool(dustRate))
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, ModContent.DustType<Jerick>(), 0f, 0f, 150, default(Color), 1.3f);
        }
