...
namespace FantasyMod2.Content.Projectiles.Minions
{
    ...
    public class RainbowBuff : ModBuff
    {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            if (player.ownedProjectileCounts[ModContent.ProjectileType<RainbowSickle>()] > 0)
            {
    ...
    public class RainbowScythe : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.buffType = ModContent.BuffType<RainbowBuff>();
            // No buffTime because otherwise the item tooltip would say something like "1 minute duration"
            Item.shoot = ModContent.ProjectileType<RainbowSickle>(); // This item creates the minion projectile
        }
    ...
    public class RainbowSickle : ModProjectile
    {
        public override void SetStaticDefaults()
        {
        ...
        private bool CheckActive(Player owner)
        {
            ...
            {
                owner.ClearBuff(ModContent.BuffType<RainbowBuff>());

                return false;
            }

            if (owner.HasBuff(ModContent.BuffType<RainbowBuff>()))
            {
