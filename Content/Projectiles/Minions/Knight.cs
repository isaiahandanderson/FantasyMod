...
namespace FantasyMod2.Content.Projectiles.Minions
{
    ...
    public class KnightBuff : ModBuff
    {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            if (player.ownedProjectileCounts[ModContent.ProjectileType<Knight>()] > 0)
            {
    ...
    public class Nail : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            Item.buffType = ModContent.BuffType<KnightBuff>();
            // No buffTime because otherwise the item tooltip would say something like "1 minute duration"
            Item.shoot = ModContent.ProjectileType<Knight>(); // This item creates the minion projectile
        }
    ...
    public class Knight : ModProjectile
    {
        public override void SetStaticDefaults()
        {
        ...
        private bool CheckActive(Player owner)
        {
            ...
            {
                owner.ClearBuff(ModContent.BuffType<KnightBuff>());

                return false;
            }

            if (owner.HasBuff(ModContent.BuffType<KnightBuff>()))
            {
