...
namespace FantasyMod2.Content.Projectiles.Minions
{
    ...
    public class BirdBuff : ModBuff
    {
        ...
        public override void Update(Player player, ref int buffIndex)
        {
            ...
            if (player.ownedProjectileCounts[ModContent.ProjectileType<BloodBird>()] > 0)
            {
    ...
    public class BloodFilledBirdCage : ModItem
    {
        public override void SetStaticDefaults()
        {
        ...
        public override void SetDefaults()
        {
            ...
            Item.shoot = ModContent.ProjectileType<BloodBird>(); // This item creates the minion projectile
        }
    ...
    public class BloodBird : ModProjectile
    {
        public override void SetStaticDefaults()
        {
