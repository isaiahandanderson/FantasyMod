...
namespace FantasyMod2.Content.Projectiles
{
    ...
    public class Dreadlord : ModProjectile
    {
        ...
        private const float WINDUP = 0.60f; // How far back the player's hand goes when winding their attack (in relation to swingRange)
        private const float UNWIND = 0.4f; // When should the sword start disappearing
        private const float SPINTIME = 6f; // How much longer a spin is than a swing
        ...
        public override string Texture => "FantasyMod2/Content/Items/Weapons/DreadlordClaymore"; // Use texture of item as projectile texture
        ...
        public void SetSwordPosition()
        {
            ...
            Projectile.scale = Size * 1f * Owner.GetAdjustedItemScale(Owner.HeldItem); // Slightly scale up the projectile and also take into account melee size modifiers
        ...
        private void PrepareStrike()
        {
            ...
            if (Timer >= prepTime)
            {
                SoundEngine.PlaySound(SoundID.Item7); // Play sword sound here since playing it on spawn is too early
        ...
        private void ExecuteStrike()
        {
            ...
            else
            {
                ...
                {
                    SoundEngine.PlaySound(SoundID.Item14); // Play sword sound again
