...
namespace FantasyMod2.Content.Projectiles
{
    ...
    public class DarkWalnutSwordProjectile : ModProjectile
    {
        ...
        private const float WINDUP = 0.20f; // How far back the player's hand goes when winding their attack (in relation to swingRange)
        ...
        public override string Texture => "FantasyMod2/Content/Items/Weapons/DarkWalnutSword"; // Use texture of item as projectile texture
