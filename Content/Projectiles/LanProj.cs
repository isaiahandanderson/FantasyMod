...
namespace FantasyMod2.Content.Projectiles
{
    ...
    public class LanProj : ModProjectile
    {
        ...
        public override void OnKill(int timeLeft)
        {
            ...
            if (Projectile.owner == Main.myPlayer)
            {
                ...
                {
                    item = Item.NewItem(Projectile.GetSource_DropAsItem(), Projectile.getRect(), ModContent.ItemType<FistOfLanbu>());
                }
        ...
        public override void OnHitNPC(NPC target, NPC.HitInfo hit, int damageDone)
        {
            ...
            target.AddBuff(ModContent.BuffType<Buffs.steel>(), 900);
