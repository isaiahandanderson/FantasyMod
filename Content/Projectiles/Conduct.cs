...
namespace FantasyMod2.Content.Projectiles
{
    ...
    /// Make sure to check out <see cref="TheConductor" />, which fires this projectile; it itself is a cloned version of the Meowmere.
    /// </summary>
    public class Conduct : ModProjectile
    {
