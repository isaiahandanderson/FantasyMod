...
using FantasyMod2.Content.BossBars;
using FantasyMod2.Content.Items;
using FantasyMod2.Content.Items.Armor;
using FantasyMod2.Content.Items.Consumables;
...
namespace FantasyMod2.Content.NPCs
{
    ...
    public class TheWatcherBody : ModNPC
    {
        ...
        {
            return ModContent.NPCType<TheWatcherMinion>();
        }
        ...
        public override void SetStaticDefaults()
        {
            ...
            {
                CustomTexturePath = "FantasyMod2/Assets/Textures/Bestiary/TheWatcher_Preview",
        ...
        public override void SetDefaults()
        {
            ...
            // Custom boss bar
            NPC.BossBar = ModContent.GetInstance<TheWatcherBossBar>();

            // The following code assigns a music track to the boss in a simple way.
            //if (!Main.dedServ)
            //{
               // Music = MusicLoader.GetMusicSlot(Mod, "FantasyMod2/Content/Assets/Music/Ropocalypse2");
            //}
        }
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            ...
            bestiaryEntry.Info.AddRange(new List<IBestiaryInfoElement> {
				...
				new FlavorTextBestiaryInfoElement("Pure Mystery Incarnate.")
            });
        }
        ...
        public override void ModifyNPCLoot(NPCLoot npcLoot)
        {
            ...
            int itemType = ModContent.ItemType<PlayingCard>();
            ...
            npcLoot.Add(ItemDropRule.BossBag(ModContent.ItemType<TheWatcherBag>()));
        ...
        public override void HitEffect(NPC.HitInfo hit)
        {
            ...
            if (NPC.life <= 0)
            {
                ...
                int backGoreType = Mod.Find<ModGore>("TheWatcherBody_Back").Type;
                int frontGoreType = Mod.Find<ModGore>("TheWatcherBody_Front").Type;
        ...
        public override void AI()
        {
            ...
            if (Timer > 1)
            {
                ...
                if (NPC.HasValidTarget && Main.netMode != NetmodeID.MultiplayerClient)
                {
                    ...
                    direction.Normalize();
                    float speed = 10f;
                    int type = ModContent.ProjectileType<RedSword>();
        ...
        private void SpawnMinions()
        {
            ...
            {
                NPC minionNPC = NPC.NewNPCDirect(entitySource, (int)NPC.Center.X, (int)NPC.Center.Y, ModContent.NPCType<TheWatcherMinion>(), NPC.whoAmI);
                ...
                TheWatcherMinion minion = (TheWatcherMinion)minionNPC.ModNPC;
        ...
        private void CheckSecondStage()
        {
            ...
            {
                if (otherNPC.type == MinionType() && otherNPC.ModNPC is TheWatcherMinion minion)
                {
        ...
        private void DoSecondStage_SpawnEyes(Player player)
        {
            ...
            if (NPC.HasValidTarget && SecondStageTimer_SpawnEyes == 0 && Main.netMode != NetmodeID.MultiplayerClient)
            {
                ...
                int type = ModContent.ProjectileType<RedArrow>();
