...
namespace FantasyMod2.Content.DamageClasss
{
    public class CrusherDamage : DamageClass
    {
        ...
        public override void SetDefaultStats(Player player)
        {
            ...
            player.GetCritChance<CrusherDamage>() += 4;
            player.GetArmorPenetration<CrusherDamage>() += 10;
